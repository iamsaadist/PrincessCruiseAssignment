...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        <h1>It&#39;s the ship... prepare to board the Princess Cruise.<asp:Image ID="Logo" runat="server" ImageAlign="Middle" ImageUrl="~/MainPage/8.jpg" Width="932px" Height="343px" />
            </h1>
